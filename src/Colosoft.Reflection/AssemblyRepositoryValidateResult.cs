...
{
    public sealed class AssemblyRepositoryValidateResult : IEnumerable<AssemblyRepositoryValidateResult.Entry>
    {
        ...
        public AssemblyRepositoryValidateResult(IEnumerable<Entry> entries)
        {
            if (entries is null)
            {
